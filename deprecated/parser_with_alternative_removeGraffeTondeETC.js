...
function remove_graffe2(text,title){
  ...
  fs.readFile(file, function (err, data) {
     ...
     parseString(data, function (err, result) {
            ...
            */
              ...
              var se = testo_intero.match(/\[\[[a-zA-Z 1-9.'|()-]+\]\]/g);
              ...
              fs.appendFile('output_data/anchor.txt', anchor, function(err){
            ...
            */    if(anchor[i].indexOf('(') === -1 && anchor[i].indexOf(')') === -1) {
                    ...
                    testo_intero = testo_intero.replace(reg_se,'[['+anchor[i]+']]');
                  }
              }
